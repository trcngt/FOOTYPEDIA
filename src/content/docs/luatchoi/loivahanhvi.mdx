...
import HandballInspector from '../../../components/HandballInspector.astro';

---

## 🎮 Khám Phá Ranh Giới Chạm Tay Chuẩn IFAB (T-Shirt Line)

Nhấp vào từng vùng trên cánh tay bên dưới để xem vị trí nào bị tính là phạm luật và vị trí nào hoàn toàn hợp lệ:
